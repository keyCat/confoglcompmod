...
- Added `USE_LEFT4DHOOKS` compile switch. Set it to 0 to compile sources with `left4downtown` instead (include converted to Transitional Syntax is provided within `include/` directory).
